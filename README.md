# AngularJS Jasmine Boilerplate Atom Package [![Build Status](https://travis-ci.org/namoscato/angular-jasmine-boilerplate-atom.svg?branch=master)](https://travis-ci.org/namoscato/angular-jasmine-boilerplate-atom)
